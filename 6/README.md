...
| -                      | -                                                             |-     |
| Invoke Async Operation | Invoke an operation asynchronously                            |/async/operationId|
| Invoke Operation       | Invoke an operation synchronously                             |/sync/operationId|
...
- POST requests to the `/async/operationId` (e.g. https://service-endpoint/async/4d517500da0acb0d65a716f61330969334630363ce4a6a9d39691026ac7908ea) along with JSON formatted payload as described by the params section of the operation metadata.

- The path argument operationId must be the ID of the operation asset.
