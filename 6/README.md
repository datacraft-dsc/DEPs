...
| --                  | --                                                                                               | yes|
| service description | name and description fields                                                                      | no|
| deployment          | Details about deployed service, if installed by the service provider | no|
| service_installation | metadata describing service installation | yes|
| inputs              | Inputs consumed by the service                                                                   | yes|
| output              | Outputs generated by the service                                                                 | yes|
| service info        | consumer-provided params on the service invocation, including data about the service agreements. | no|
|  configuration options   |provider specified options to tune the invoke job|
