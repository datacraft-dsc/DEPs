...
|-------------|------------|----------|--------------------------------------------|
| **modes**   | list       | Optional | A list with values "sync" and/or "async"   |
...
|--------------|------------|----------|-----------------------------------------------------------------------------------|-----------------|
| **type**     | list       | Yes      | Must be one of **asset** or **string**                                            | params, results |
| **position** | int        | Optional | The value is an integer indicating the argument index.                            | params          |
| **required** | boolean    | Optional | Indicates that this parameter is mandatory. If not present, default value is True | params          |
|              |            |          |                                                                                   |                 |

Example of an operation metadata definition:
```json
{
  "name": "hashing",
